...
you should go through and investigate anything that is not clear yourself using the file references in the existing code or by finding them yourself. you may search the web. use subagents liberally and as necessary to delegate exploration.
